	...
	void shoot(Enemy e) {
		...
		if (gunCooldown<=0) {
			...
			for (int i = 0;i<bulletCount;i++) {
				...
				ProjectileManager.addProjectile(new ProjectileBullet(this, x+towerSize/2, y+towerSize/2, damage, canDamageMetal, angle, TOWER_BULLET_NORMAL_INITIAL_VELOCITY, TOWER_BULLET_NORMAL_ACCELERATION));
			}
		}
	}
